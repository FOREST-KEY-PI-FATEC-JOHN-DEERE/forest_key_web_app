    ...
    <MainLayout pageTitle={t('history')}>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          <button className="p-2 rounded-lg hover:bg-[var(--color-card-hover)] transition-colors">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-[var(--color-divider)] rounded-lg p-4 ">
                ...
                <input
                  ...
                  placeholder={t('placeholder_username')}
                    className="w-full border border-[var(--color-divider)] rounded-md px-3 py-2 text-sm bg-[var(--color-card)] text-[var(--color-foreground)] focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="border border-[var(--color-divider)] rounded-lg p-4 ">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`w-10 h-5 rounded-full relative transition-colors ${
                        autoUpdate ? "bg-green-500" : "bg-[var(--color-divider)]"
                      }`}
                    >
                      <span
                ...
                {/* Campo da senha */}
                {autoUpdate ? (
                  <div className="w-full border border-dashed border-[var(--color-divider)] rounded-md px-3 py-2 text-sm text-[var(--color-text-secondary)] ">
                    {t('automatic_update')}
                  </div>
                ) : (
                  <input
            ...
            <div className="flex gap-4">
              ...
              <button className="px-8 py-2 bg-green-600 hover:bg-green-700  font-semibold rounded-md transition">
                {t('edit')}
              </button>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-px flex-1 bg-[var(--color-divider)]"></div>
                </div>
                <div>
                  <p className="text-sm font-semibold text-[var(--color-foreground)]">05/03/2025 08:30:00</p>
                  <p className="text-sm text-[var(--color-text-secondary)]">{t('password_changed_by')} - {t('system_caps')} - <br />{t('reason')}: {t('automatic_update')}</p>
                </div>
              </div>
